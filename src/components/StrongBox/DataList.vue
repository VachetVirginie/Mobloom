    ...
    <div v-if="areDatasLoaded" class="m-2">
      ...
      <table v-for="data in datas" :key="data" class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
        ...
        <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
          <td class="border-grey-light border hover:bg-gray-100 p-3">{{ data.siteTitle }}</td>
          ...
          <td class="border-grey-light border hover:bg-gray-100 p-3 text-pink hover:text-red-600 hover:font-medium cursor-pointer">
